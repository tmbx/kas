...
Modalbox.Methods = {
	...
	_hide: function(event) { // Internal hide method to use with overlay and close link
		...
		// (C) 2009-2012 Opersys inc.
		// Call "dialog closed" callback, not necessarily the same as the afterHide one
		// Fix by Yasser Idris 
		this.event("onDialogClosed");
		// End of fix //
	...
	_setPosition: function () {
		$(this.MBwindow).setStyle({top:"100px", left: (($(this.MBoverlay).getWidth() - $(this.MBwindow).getWidth()) / 2 ) + "px"});
	},
