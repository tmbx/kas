...
##### Config
from kascfg.model.freemium.meta import metadata, Session

# Models
model_imports = (('kascfg.model.freemium.freemium_user', 'User'),)

# Get url function.
from kascfg.lib.config import get_freemium_db_url
get_url = get_freemium_db_url
...
def import_models():
    ...
    for module_name, model_name in model_imports:
